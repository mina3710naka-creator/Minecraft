...
# ============================================================
execute positioned ^ ^ ^0.25 if entity @e[tag=!sc.ent,type=!minecraft:player,type=!minecraft:item,type=!minecraft:experience_orb,type=!minecraft:armor_stand,type=!minecraft:interaction,type=!minecraft:arrow,type=!minecraft:snowball,distance=..3] run return run function sc:hook/hit
