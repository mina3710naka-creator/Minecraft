# ============================================================
#  巨大な氷塊の落下（実行者＝falling_block / 実行位置＝その場）
...
execute if entity @e[tag=!uw.ent,type=!minecraft:player,type=!minecraft:item,type=!minecraft:experience_orb,distance=..2.5] run function uw:snow/icicle/giant_hit
execute unless entity @s run return 0
...
tp @s ~ ~-1 ~
particle minecraft:block minecraft:blue_ice ~ ~ ~ 0.4 0.4 0.4 0 6 normal @a
