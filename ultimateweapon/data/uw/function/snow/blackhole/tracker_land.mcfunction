...
playsound minecraft:entity.generic.explode player @a ~ ~ ~ 1 0.4
particle minecraft:portal ~ ~ ~ 1 1 1 1 80 normal @a
particle minecraft:explosion_emitter ~ ~ ~ 0 0 0 0 1 normal @a
particle minecraft:reverse_portal ~ ~ ~ 1.5 1.5 1.5 0.5 20 normal @a
