...
execute if score @s uw.mode matches 0 run title @s actionbar {"text":"モード1: 自動追尾弾","color":"aqua","bold":true}
execute if score @s uw.mode matches 1 run title @s actionbar {"text":"モード2: 持続レーザー","color":"red","bold":true}
